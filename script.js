const translations = {
  zh: {
    ...
    educationLabel: '教育背景', phdLine: '计算机系博士生', supervisorLine: '导师：曹建农教授、陈云天教授 · PolyU Research Postgraduate Scholarship', bachelorLine: '数学荣誉学士 · 金融学士（双学位）', awardLine: '专业排名前 3.7% · 优秀毕业生 · 2024 高教社杯全国大学生数学建模竞赛国家一等奖',
